...
import brandMoc from './assets/brand-moc-trim.webp'
import brandMocWhite from './assets/brand-moc-white.svg'
import brandEsar from './assets/brand-esar-trim.webp'
import brandPin from './assets/brand-pin-trim.webp'
import brandPinLight from './assets/brand-pin-light.webp'
import brandNuzul from './assets/brand-nuzul-trim.webp'
import brandFlyakeed from './assets/brand-flyakeed-trim.webp'
import brandFlyakeedLight from './assets/brand-flyakeed-light.webp'
import brandQubit from './assets/brand-qubit-trim.webp'
import brandHatif from './assets/brand-hatif-trim.webp'
import brandCarsvid from './assets/brand-carsvid-trim.webp'
