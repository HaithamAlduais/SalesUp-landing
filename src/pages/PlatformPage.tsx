  ...
  const roles = [
    ...
    },
    {
      ...
      points: [
        ...
        L('تتابع المستحق والجاري وإجمالي ما كسبته', 'Track payable, pending and total earnings'),
  ...
  return (
    <section className="platform-final">
      <div>
        ...
        <h2>{L('سجّل بخطوة وحدة، اختر أول منتج، وابدأ تكسب من أول صفقة تقفلها', 'Sign up in one step, choose your first product, and earn from your first closed deal')}</h2>
